...
class FuncionarioController extends MainController
{
    public function show($id){
        ...
        $this->renderView('Views/Admin/RegistoFuncionarios/show.php', ['funcionario' => $funcionario]);
    }
    public function index(){
        $funcionarios = User::all(array('conditions' => array('role = ?','funcionario')));
        $this->renderView('Views/Admin/RegistoFuncionarios/index.php', ['funcionarios' => $funcionarios]);
    }
    public function create(){
        // redireciona para vista para criar um novo
        $this->renderView('Views/Admin/RegistoFuncionarios/create.php');
    }
    ...
    public function edit($id){
        ...
        if($funcionario->is_valid()){
            $this->renderView('Views/Admin/RegistoFuncionarios/edit.php', ['funcionario' => $funcionario]);
        } else {
            $this->renderView('Views/Admin/RegistoFuncionarios/index.php');
        }
    }
    public function atualizarPass(){
        ...
        if($funcionario->is_valid()){
            $this->renderView('Views/Admin/RegistoFuncionarios/updateEmail.php', ['funcionario' => $funcionario]);
        } else {
            $this->renderView('Views/Admin/RegistoFuncionarios/index.php');
        }
    }
    public function update($id){
        ...
        if($funcionario->is_valid()){
            ...
            $this->renderView('Views/Admin/RegistoFuncionarios/edit.php');
        }
    }
