                        ...
                        <form action="router.php?c=cliente&a=update&id=<?= $cliente->id ?>" method="post" class="needs-validation row justify-content-center">
                            <div class="row">
                                ...
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $cliente->username ?>" class="form-control <?php if (isset($error) && $error['username']) echo 'is-invalid' ?>" id="inputUsername" name="username" required></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="email" value="<?= $cliente->email ?>" class="form-control <?php if (isset($error) && $error['email']) echo 'is-invalid' ?>" id="inputEmail" name="email" required></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $cliente->telefone ?>" class="form-control <?php if (isset($error) && $error['telefone']) echo 'is-invalid' ?>" id="inputTelefone" name="telefone" required></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $cliente->nif ?>" class="form-control <?php if (isset($error) && $error['nif']) echo 'is-invalid' ?>" id="inputNIF" name="nif" required></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" class="form-control" value="<?= $cliente->morada ?>" id="inputMorada" name="morada" required></span></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4 mb-3 text-start"><span class="fs-5">Codigo Postal:</span></div>
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $cliente->codpostal ?>" class="form-control <?php if (isset($error) && $error['codpostal']) echo 'is-invalid' ?>" id="inputCodPostal" name="codpostal" required></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $cliente->localidade ?>" class="form-control" id="inputLocalidade" name="localidade" required></span></div>
                                </div>
                            </div>
