    ...
    <div class="row" style="margin-top: 5rem;">
        ...
        <div class="col-6 shadow-lg" style="height: 30vh;">
            <div class="row">
                ...
                <div class="col">
                    <div class="row mt-5">
                        <form action="router.php?c=iva&a=update&id=<?= $iva->id ?>" method="post" class="needs-validation row justify-content-center">
                            <div class="row">
                                <div class="col-4 mb-3 text-start"><span class="fs-5">Descricao:</span></div>
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $iva->descricao ?>" class="form-control" id="inputDescricao" name="descricao" required></span></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4 mb-3 text-start"><span class="fs-5">Percentagem:</span></div>
                                <div class="col mb-2 text-end">
                                    <div class="row"><span class="fs-5"><input type="text" value="<?= $iva->percentagem ?>" class="form-control <?php if (isset($error) && $error['descricao']) echo 'is-invalid' ?>" id="inputPercentagem" name="percentagem" required></span></div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="1" name="vigor" id="radioVigor" <?php if ($iva->vigor == 1) {
                                                                                                                                        echo 'checked';
                                                                                                                                    }  ?>>
                                        ...
                                        <div class="col">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" value="0" name="vigor" id="radioVigor" <?php if ($iva->vigor == 0) echo 'checked' ?>>
                                                <label class="form-check-label" for="vigor">
                                                    Não
                                                </label>
                                            </div>
