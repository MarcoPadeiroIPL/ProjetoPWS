                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col">
                                <form action="router.php?c=produto&a=store" method="post" class="needs-validation row justify-content-center">
                                    <div class="row mb-2 text-end"><span class="fs-5"><input type="text" class="form-control" id="inputDescricao" name="descricao" required></span></div>
                                    <div class="row mb-2 text-end"><span class="fs-5"><input type="text" class="form-control" id="inputPreco" name="preco" required></span></div>
                                    <div class="row mb-2 text-end"><span class="fs-5"><input type="text" class="form-control" id="inputStock" name="stock" required></span></div>
